				...
				<div className='row pt-4'>
					<div className='col-sm-8 col-md-6 col-lg-5 col-xl-4 mx-auto text-light'>
						...
						<div className='col-12 pt-3 pb-1 d-flex align-items-center justify-content-center'>
							<a href='https://instagram.com/tobiolalusi' target='_blank' rel='noopener noreferrer' className='d-flex flex-column mx-2'>
								<img src={icon.instagram} style={{height: '2.5rem'}} alt='Instagram' />
							</a>
							<a href='https://linkedin.com/in/tobby1177' target='_blank' rel='noopener noreferrer' className='d-flex flex-column mx-1'>
								<img src={icon.linkedin} style={{height: '2.75rem'}} alt='LinkedIn' />
							</a>
							<a href='https://github.com/tobby1177' target='_blank' rel='noopener noreferrer' className='d-flex flex-column mx-2'>
								<img src={icon.github} style={{height: '2.5rem'}} alt='GitHub' />
							</a>
							<a href='mailto:tobby1177@yahoo.com' target='_blank' rel='noopener noreferrer' className='d-flex flex-column mx-2'>
